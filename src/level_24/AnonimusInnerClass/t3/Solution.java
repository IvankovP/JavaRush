package level_24.AnonimusInnerClass.t3;
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Long timeStock1 = ((Date) stock1.get("date")).getTime();
                Long timeStock2 = ((Date) stock2.get("date")).getTime();
                result = timeStock1.compareTo(timeStock2) * -1;
                if (result != 0) return result;

                if (stock1.containsKey("last") && stock2.containsKey("last")) {
                    Double profitStock1 = (Double) stock1.get("last") - (Double) stock1.get("open");
                    Double profitStock2 = (Double) stock2.get("last") - (Double) stock2.get("open");
                    result = profitStock1.compareTo(profitStock2) * -1;
                }
                return result;
            }
        });
