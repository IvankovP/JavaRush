...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        if (specificModifier == 1) return Modifier.isPublic(allModifiers);
        else if (specificModifier == 8) return Modifier.isStatic(allModifiers);
        else return false;
    }
