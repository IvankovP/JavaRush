package level_26.ThreadYield.t1;
...
public class Solution {
    ...
    public static synchronized void moveMoney(Account from, Account to, int amount) {
        ...
        System.out.printf("Транзакци №%d: списание $%d со счета №%d. Баланс: %d.%n", transactionNumber, amount, from.getNumber(), from.getBalance());
        from.setBalance(from.getBalance() - amount);
        Thread.yield();

        System.out.printf("Транзакци №%d: зачисление $%d на счет №%d. Баланс: %d.%n", transactionNumber, amount, to.getNumber(), to.getBalance());
