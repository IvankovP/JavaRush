package level_30.autoboxingCharacter.t5;

import java.math.BigDecimal;
import java.util.concurrent.ThreadLocalRandom;

import static level_30.autoboxingCharacter.t5.Constants.*;
...
public class Sportsman {
    ...
    public void printResultInfo() {
        System.out.printf("Спортсмен № %02d: Врем - %6.2f секунд. Средн скорость - %2.4f км/час. Количество промахов %d%n", number, resultTime.doubleValue(), averageSpeed, countHitOutTarget);
    }
}
