package level_30.autoboxingBoolean.t1;
...
public class Solution {
    ...
    private BlockingQueue messageQueue = new LinkedBlockingQueue(); // Тут будут хранитьс все сообщени

    private BlockingQueue fakeDatabase = new LinkedBlockingQueue();

    public static void main(String[] args) throws InterruptedException {
        // Статики во многих местах неуместны, поэтому помещаем все данные в пол класса,
    ...
    private void persistData(Collection batch) {
        // Представим, что тут мы коннектимс к базе данных, и сохранем данные в нее
